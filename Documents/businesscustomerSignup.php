		...
		<nav class="navbar navbar-inverse navbar-no-bg" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.html">Businesscustomer Signup</a>
				</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-7 text">
                            <h1 style="color:black;font-size:50px;"><strong>Drinking Store</strong> Registration<br/><br/>For Business</h1>
                        ...
                        <div class="col-sm-5 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="register_business.php" method="post" class="registration-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="Name">name</label>
			                        	<input type="text" name="name" placeholder="Company Name..." class="form-first-name form-control" id="Name">
			                        </div>
