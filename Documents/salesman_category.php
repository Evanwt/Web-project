...
<head>
    ...
    <title>Browse by Category for Salesman</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2>Browse by Category for Salesman</h2>
      

    <?php
  require_once('include/functions_salesman.php');
  $browse_type=$_POST['browse_type'];
  
  if (!get_magic_quotes_gpc()){ 
    $browse_type = addslashes($browse_type);  
  }

  category($browse_type);
  ?> 
